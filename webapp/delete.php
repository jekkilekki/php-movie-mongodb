...
<body>
    ...
    <div data-role="page" id="page3">
        ...
        <div data-role="content">
            <form name="form3-1" method="POST" action="delete_result.php" data-ajax="false" enctype="multipart/form-data">
                <div class="ui-body ui-body-a">
                    ...
                    <label>영화명: </label>
                    <input type="text" name="title" id="title" data-mini="true" data-inline="true" value="<?php echo $title; ?>">
                    <label>상영날짜 (yyyy-mm-dd): </label>
                    <input type="date" name="date" id="date" data-mini="true" data-inline="true" value="<?php echo $date; ?>">
                    <label>관람료: </label>
                    <input type="text" name="price" id="price" data-mini="true" data-inline="true" value="<?php echo $price; ?>">
                    <label>포스터: </label>
                    <input type="file" name="poster" id="poster" data-mini="true" data-inline="true" value="<?php echo $poster; ?>">
